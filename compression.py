...
def myCompress (inputFile):
    ...
    with open(inputFile, mode="rb") as fin, open("Compressed_Files/Compressed_Data.csv", mode="wb") as fout:
        data = fin.read()
...
def myDecompress (compressedFile):
    ...
    with open(compressedFile, mode="rb") as fin, open("Decompressed_Files/Decompressed_Data.csv", mode="wb") as fout:
        data = fin.read()
